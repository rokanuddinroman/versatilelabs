...
export default function NewsLetter({}: Props) {
  ...
  return (
    <>
      ...
      <div className="w-full p-5 md:p-6 space-y-5 bg-white shadow-md rounded-xl md:max-w-[600px] text-blue-500">
          ...
          onSubmit={async (values, { resetForm }) => {
            ...
            try {
              ...
              if (datas.status >= 400) {
                ...
                setMessage(
                  "Error joining the newsletter 400. You can directly contact me at github@ebraj."
                );
                setTimeout(() => {
                  setMessage("");
              ...
              setStatus(500);
              setMessage(
                "Error joining the newsletter 500. You can directly contact me at github@ebraj."
              );
              setTimeout(() => {
                setMessage("");
                setButtonDisabled(false);
        ...
        >
          <Form>
            <div className="flex items-center space-x-2">
              ...
              />
              <button
                className="px-5 py-3 font-bold text-gray-500 transition-all bg-gray-800 rounded-md hover:bg-gray-900 hover:scale-105 disabled:opacity-80"
                type="submit"
